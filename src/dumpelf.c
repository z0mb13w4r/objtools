...
static int dump_notes5Dmips(const pbuffer_t p, const poptions_t o, const uint64_t n_descsz, const handle_t notes) {
  int n = 0;
//  uint32_t pad[6];
  n += printf_text("SPARE0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
...
//  uint32_t uregs[32];
  ...
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("AT", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("V0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("V1", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("A0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("A1", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("A2", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("A3", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T1", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T2", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T3", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T4", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T5", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T6", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T7", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S1", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S2", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S3", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S4", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S5", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S6", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("S7", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T8", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("T9", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("K0", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("K1", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("GP", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("SP", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
  n += printf_text("FP", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
...
//  uint32_t cp0_badvaddr;
  ...
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
//  uint32_t cp0_status;
  n += printf_text("CP0 (STATUS)", USE_LT | USE_COLON | USE_TAB2);
  n += printf_nice(fgetu32(notes), USE_FHEX32 | USE_EOL);
//  uint32_t cp0_cause;
