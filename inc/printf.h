...
#define USE_CHAR          (32)
#define USE_CHARCTRL      (33)
#define USE_TIMEDATE      (34)
#define USE_ERROR         (35)
#define USE_CORRUPT       (36)
#define USE_UNKNOWN       (37)
#define USE_WARNING       (38)

#define USE_HEXDUMP       (0)
#define USE_STRDUMP       (1)
#define USE_CODEDUMP      (2)
#define USE_STR           (3)
#define USE_STRSIZE       (4)
#define USE_STR16         (5)
#define USE_STR16SIZE     (6)
#define USE_HEX           (7)
#define USE_MD5           (8)
#define USE_SHA1          (9)
#define USE_SHA256        (10)
#define USE_SHA512        (11)
#define USE_HASHALL       (12)
#define USE_CRC8          (13)
#define USE_CRC16         (14)
#define USE_CRC32         (15)
#define USE_CRCALL        (16)
#define USE_ROT5          (17)
#define USE_ROT13         (18)
#define USE_ROT18         (19)
#define USE_BASE64        (20)
#define USE_GUID          (21)
