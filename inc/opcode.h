...
#define OPCODE_DWARF_DEBUG         (OPCODE_MAXITEMS + 7)
#define OPCODE_DWARF_ERROR         (OPCODE_MAXITEMS + 8)
#define OPCODE_DWARF_SRCFILES      (OPCODE_MAXITEMS + 9)
#define OPCODE_DWARF_STATISTICS    (OPCODE_MAXITEMS + 10)
