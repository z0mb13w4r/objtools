...
#define OPCODE_DWARF_ERROR         (2)
#define OPCODE_SYMBOLS             (3)
#define OPCODE_SYMBOLS_DYNAMIC     (4)
#define OPCODE_DISASSEMBLER        (5)
#define OPCODE_OUTDATA             (6)
#define OPCODE_MAXITEMS            (7)
...
#define OPCODE_DWARF_PTR           (OPCODE_MAXITEMS + 6)
...
#define ocgetdwarfptr(x)           CAST(Dwarf_Debug*, ocget(x, OPCODE_DWARF_PTR))
#define ocgetdwarferr(x)           CAST(Dwarf_Error*, ocget(x, OPCODE_DWARF_ERROR))
