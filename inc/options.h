...
#define OPTOBJDUMP_DISASSEMBLE_ALL                 (1 << 0)
#define OPTOBJDUMP_DISASSEMBLE                     (1 << 1)
#define OPTOBJDUMP_SOURCE_CODE                     (1 << 2)
#define OPTOBJDUMP_DYNAMIC_SYMBOLS                 (1 << 3)
#define OPTOBJDUMP_DEBUGGING                       (1 << 4)
#define OPTOBJDUMP_SECTIONS                        (1 << 5)
#define OPTOBJDUMP_SYMBOLS                         (1 << 6)
#define OPTOBJDUMP_LINE_NUMBERS                    (1 << 7)
#define OPTOBJDUMP_FILE_HEADER                     (1 << 8)
#define OPTOBJDUMP_PRIVATE_HEADER                  (1 << 9)
#define OPTOBJDUMP_SECTION_HEADER                  (1 << 10)
#define OPTOBJDUMP_DEBUG_ABBREV                    (1 << 11)
#define OPTOBJDUMP_DEBUG_ADDR                      (1 << 12)
#define OPTOBJDUMP_DEBUG_CU_INDEX                  (1 << 13)
#define OPTOBJDUMP_DEBUG_FRAME                     (1 << 14)
#define OPTOBJDUMP_DEBUG_FRAME_INTERP              (1 << 15)
#define OPTOBJDUMP_DEBUG_INFO                      (1 << 16)
#define OPTOBJDUMP_DEBUG_LINK                      (1 << 17)
#define OPTOBJDUMP_DEBUG_LINK_FOLLOW               (1 << 18)
#define OPTOBJDUMP_DEBUG_LINE_RAW                  (1 << 19)
#define OPTOBJDUMP_DEBUG_LINE_DECODED              (1 << 20)
#define OPTOBJDUMP_DEBUG_MACRO                     (1 << 21)
#define OPTOBJDUMP_DEBUG_LOC                       (1 << 22)
#define OPTOBJDUMP_DEBUG_ARANGES                   (1 << 23)
#define OPTOBJDUMP_DEBUG_RANGES                    (1 << 24)
#define OPTOBJDUMP_DEBUG_STR                       (1 << 25)
#define OPTOBJDUMP_DEBUG_PUBNAMES                  (1 << 26)
#define OPTOBJDUMP_DEBUG_PUBTYPES                  (1 << 27)
#define OPTOBJDUMP_TRACE_ARANGES                   (1 << 28)
#define OPTOBJDUMP_TRACE_ABBREV                    (1 << 29)
#define OPTOBJDUMP_TRACE_INFO                      (1 << 30)
#define OPTOBJDUMP_GDB_INDEX                       (1 << 31)
