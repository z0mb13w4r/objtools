...
#define OPTDEBUGELF_DEBUG_FRAME_DECODED            U64MASK(34)
...
#define OPTDEBUGELF_TAGS                           U64MASK(52)
#define OPTDEBUGELF_DEBUGGING                      (0x1FFFFFULL << 30)

#define OPTDEBUGELF_DEBUGGING_DBGS     (OPTDEBUGELF_DEBUG_FRAME | OPTDEBUGELF_DEBUG_ARANGES | OPTDEBUGELF_DEBUG_INFO \
                                           | OPTDEBUGELF_DEBUG_ABBREV | OPTDEBUGELF_DEBUG_STR | OPTDEBUGELF_DEBUG_MACRO)

#define OPTDEBUGELF_DEBUGGING_TAGS     (OPTDEBUGELF_DEBUGGING_DBGS | OPTDEBUGELF_TAGS)

#define OPTDEBUGELF_DEBUG_LINE_MASK    (OPTDEBUGELF_DEBUG_LINE | OPTDEBUGELF_DEBUG_LINE_DECODED)
#define OPTDEBUGELF_DEBUG_FRAME_MASK   (OPTDEBUGELF_DEBUG_FRAME | OPTDEBUGELF_DEBUG_FRAME_DECODED)
...
#define ACT_DEC8E                                  (603)
#define ACT_DEC16D                                 (604)
#define ACT_DEC16E                                 (605)
#define ACT_DEC32D                                 (606)
#define ACT_DEC32E                                 (607)
#define ACT_HEX8D                                  (608)
#define ACT_HEX8E                                  (609)
#define ACT_HEX16D                                 (610)
#define ACT_HEX16E                                 (611)
#define ACT_HEX32D                                 (612)
