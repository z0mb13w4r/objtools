...
#define OPTDISASSEMBLE_GET(x)                      GET_XX8(x, 0)
#define OPTDISASSEMBLE_SET(x)                      SET_XX8(x, 0)
#define OPTDISADDEMBLE_MASK                        SET_XX8(255, 0)

#define OPTDISASSEMBLE_X86_64                      OPTDISASSEMBLE_SET(1)
#define OPTDISASSEMBLE_I386                        OPTDISASSEMBLE_SET(2)
#define OPTDISASSEMBLE_I8086                       OPTDISASSEMBLE_SET(3)
#define OPTDISASSEMBLE_AMD64                       OPTDISASSEMBLE_SET(4)
#define OPTDISASSEMBLE_INTEL64                     OPTDISASSEMBLE_SET(5)
#define OPTDISASSEMBLE_ARM32                       OPTDISASSEMBLE_SET(6)
#define OPTDISASSEMBLE_ARM64                       OPTDISASSEMBLE_SET(7)
#define OPTDISASSEMBLE_RISCV32                     OPTDISASSEMBLE_SET(8)
#define OPTDISASSEMBLE_RISCV64                     OPTDISASSEMBLE_SET(9)
#define OPTDISASSEMBLE_MIPS1                       OPTDISASSEMBLE_SET(10)
#define OPTDISASSEMBLE_MIPS2                       OPTDISASSEMBLE_SET(11)
#define OPTDISASSEMBLE_MIPS3                       OPTDISASSEMBLE_SET(12)
#define OPTDISASSEMBLE_MIPS4                       OPTDISASSEMBLE_SET(13)
#define OPTDISASSEMBLE_MIPS5                       OPTDISASSEMBLE_SET(14)
#define OPTDISASSEMBLE_MIPS32                      OPTDISASSEMBLE_SET(15)
#define OPTDISASSEMBLE_MIPS32R2                    OPTDISASSEMBLE_SET(16)
#define OPTDISASSEMBLE_MIPS32R6                    OPTDISASSEMBLE_SET(17)
#define OPTDISASSEMBLE_MIPS64                      OPTDISASSEMBLE_SET(18)
#define OPTDISASSEMBLE_MIPS64R2                    OPTDISASSEMBLE_SET(19)
#define OPTDISASSEMBLE_MIPS64R6                    OPTDISASSEMBLE_SET(20)
#define OPTDISASSEMBLE_ATT                         U64MASK(9)
#define OPTDISASSEMBLE_INTEL                       U64MASK(10)
#define OPTDISASSEMBLE_ATT_MNEMONIC                U64MASK(11)
#define OPTDISASSEMBLE_INTEL_MNEMONIC              U64MASK(12)
...
#define OPRPROGRAM_COREDUMPDETAILED                U64MASK(48)
#define OPRPROGRAM_NOWARNINGS                      U64MASK(49)
...
#define OPTCOREELF_FILEHEADER                      OPTREADELF_FILEHEADER
#define OPTCOREELF_SECTIONGROUPS                   OPTREADELF_SECTIONGROUPS
#define OPTCOREELF_SECTIONHEADERS                  OPTREADELF_SECTIONHEADERS
#define OPTCOREELF_SECTIONDETAILS                  OPTREADELF_SECTIONDETAILS
#define OPTCOREELF_PROGRAMHEADERS                  OPTREADELF_PROGRAMHEADERS
#define OPTCOREELF_SYMBOLS                         OPTREADELF_SYMBOLS
#define OPTCOREELF_RELOCS                          OPTREADELF_RELOCS
#define OPTCOREELF_UNWIND                          OPTREADELF_UNWIND
#define OPTCOREELF_DYNAMIC                         OPTREADELF_DYNAMIC
#define OPTCOREELF_HISTOGRAM                       OPTREADELF_HISTOGRAM
#define OPTCOREELF_ARCHSPECIFIC                    OPTREADELF_ARCHSPECIFIC
#define OPTCOREELF_NOTES                           OPTREADELF_NOTES
#define OPTCOREELF_VERSION                         OPTREADELF_VERSION
#define OPTCOREELF_USEDYNAMIC                      OPTREADELF_USEDYNAMIC

#define OPTCOREELF_HEADERS             (OPTCOREELF_FILEHEADER | OPTCOREELF_SECTIONHEADERS | OPTCOREELF_PROGRAMHEADERS)

#define OPTCOREELF_ALL                 (OPTCOREELF_SYMBOLS | OPTCOREELF_RELOCS | OPTCOREELF_UNWIND \
                                           | OPTCOREELF_DYNAMIC | OPTCOREELF_FILEHEADER | OPTCOREELF_SECTIONHEADERS \
                                           | OPTCOREELF_SECTIONGROUPS | OPTCOREELF_PROGRAMHEADERS | OPTCOREELF_VERSION \
                                           | OPTCOREELF_HISTOGRAM | OPTCOREELF_ARCHSPECIFIC | OPTCOREELF_NOTES)

#define OPTCOREELF_SECTIONMASK         (OPTCOREELF_SECTIONHEADERS | OPTCOREELF_SECTIONDETAILS)
...
#define OPTREADPE_DOSSTUB                          U64MASK(13)
...
#define OPTREADPE_ALL                  (OPTREADPE_DOSHEADER | OPTREADPE_NTHEADER | OPTREADPE_SECTIONHEADERS \
                                           ...
                                           | OPTREADPE_VERSION | OPTREADPE_DOSSTUB | OPTREADPE_DETECT)
