...
#define OCINSN_CMP                     (231)
#define OCINSN_TST                     (232)
#define OCINSN_MOV                     (233)
#define OCINSN_Bxx                     (234)
#define OCINSN_Jxx                     (235)
#define OCINSN_ADD                     (236)
#define OCINSN_AND                     (237)
#define OCINSN_DEC                     (238)
#define OCINSN_DIV                     (239)
#define OCINSN_INC                     (240)
#define OCINSN_MUL                     (241)
#define OCINSN_NEG                     (242)
#define OCINSN_NOT                     (243)
#define OCINSN_ORR                     (244)
#define OCINSN_ROx                     (245)
#define OCINSN_SUB                     (246)
#define OCINSN_SxA                     (247)
#define OCINSN_SxL                     (248)
#define OCINSN_XOR                     (249)
#define OCINSN_PSH                     (250)
#define OCINSN_POP                     (251)
#define OCINSN_RET                     (252)
#define OCINSN_NOP                     (253)
#define OCINSN_UNDEF                   (254)
#define OCINSN_TOINT                   (255)
