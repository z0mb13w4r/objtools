...
#define OCINSN_PI                      (209)
#define OCINSN_LOGE                    (210)
#define OCINSN_LOG2                    (211)
#define OCINSN_LOG10                   (212)
#define OCINSN_FXCH                    (213)
#define OCINSN_XCHG                    (214)
#define OCINSN_INS                     (215)
#define OCINSN_OUTS                    (216)
#define OCINSN_CMP                     (217)
#define OCINSN_TST                     (218)
#define OCINSN_BTST                    (219)
#define OCINSN_LDA                     (220)
#define OCINSN_MOV                     (221)
#define OCINSN_STA                     (222)
#define OCINSN_Bxx                     (223)
#define OCINSN_Jxx                     (224)
#define OCINSN_ADD                     (225)
#define OCINSN_AND                     (226)
#define OCINSN_DEC                     (227)
#define OCINSN_DIV                     (228)
#define OCINSN_INC                     (229)
#define OCINSN_MAX                     (230)
#define OCINSN_MIN                     (231)
#define OCINSN_MUL                     (232)
#define OCINSN_NEG                     (233)
#define OCINSN_NOT                     (234)
#define OCINSN_ORR                     (235)
#define OCINSN_REM                     (236)
#define OCINSN_ROx                     (237)
