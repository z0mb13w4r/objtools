...
#define OCINSN_CMP                     (223)
#define OCINSN_TST                     (224)
#define OCINSN_BTST                    (225)
#define OCINSN_LDA                     (226)
#define OCINSN_MOV                     (227)
#define OCINSN_STA                     (228)
#define OCINSN_Bxx                     (229)
#define OCINSN_Jxx                     (230)
#define OCINSN_ADD                     (231)
#define OCINSN_AND                     (232)
#define OCINSN_DEC                     (233)
#define OCINSN_DIV                     (234)
#define OCINSN_INC                     (235)
#define OCINSN_MAX                     (236)
#define OCINSN_MIN                     (237)
#define OCINSN_MUL                     (238)
#define OCINSN_NEG                     (239)
#define OCINSN_NOT                     (240)
#define OCINSN_ORR                     (241)
#define OCINSN_REM                     (242)
#define OCINSN_ROx                     (243)
#define OCINSN_SUB                     (244)
#define OCINSN_SxA                     (245)
#define OCINSN_SxL                     (246)
#define OCINSN_XOR                     (247)
#define OCINSN_PSH                     (248)
#define OCINSN_POP                     (249)
#define OCINSN_HLT                     (250)
#define OCINSN_RET                     (251)
#define OCINSN_NOP                     (252)
