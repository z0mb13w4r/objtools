...
#define OCINSTRUCTION_RET              ((0x04) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_PUSH             ((0x05) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_POP              ((0x06) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_ADD              ((0x07) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SUB              ((0x08) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_AND              ((0x09) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOV              ((0x0a) | OCINSTRUCTION_OPERAND2)
...
#define OCINSTRUCTION_NOP0             ((0xfe) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_NOP1             ((0xff) | OCINSTRUCTION_OPERAND1)
