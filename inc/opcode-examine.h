...
#define OCINSTRUCTION_ALIGNED          U64MASK(21)
#define OCINSTRUCTION_UNALIGNED        U64MASK(22)
#define OCINSTRUCTION_NOCHECK          U64MASK(23)
#define OCINSTRUCTION_NOTRACK          U64MASK(24)
#define OCINSTRUCTION_PI               U64MASK(25)
#define OCINSTRUCTION_ONE              U64MASK(26)
#define OCINSTRUCTION_TEN              U64MASK(27)
#define OCINSTRUCTION_TWO              U64MASK(28)
#define OCINSTRUCTION_FOUR             U64MASK(29)
#define OCINSTRUCTION_ZERO             U64MASK(30)
#define OCINSTRUCTION_LOG2             U64MASK(31)
#define OCINSTRUCTION_LOGE             U64MASK(32)
#define OCINSTRUCTION_LOG10            U64MASK(33)
#define OCINSTRUCTION_EULER            U64MASK(34)
#define OCINSTRUCTION_LT               U64MASK(35)
#define OCINSTRUCTION_RT               U64MASK(36)
#define OCINSTRUCTION_A                U64MASK(37)
#define OCINSTRUCTION_B                U64MASK(38)
#define OCINSTRUCTION_C                U64MASK(39)
#define OCINSTRUCTION_E                U64MASK(40)
#define OCINSTRUCTION_G                U64MASK(41)
#define OCINSTRUCTION_L                U64MASK(42)
#define OCINSTRUCTION_N                U64MASK(43)
#define OCINSTRUCTION_O                U64MASK(44)
#define OCINSTRUCTION_S                U64MASK(45)
#define OCINSTRUCTION_BND              U64MASK(46)
#define OCINSTRUCTION_REP              U64MASK(47)
#define OCINSTRUCTION_LOCK             U64MASK(48)
#define OCINSTRUCTION_DATA             U64MASK(49)
...
#define OCINSTRUCTION_AE               (OCINSTRUCTION_A | OCINSTRUCTION_E)
#define OCINSTRUCTION_BE               (OCINSTRUCTION_B | OCINSTRUCTION_E)
#define OCINSTRUCTION_GE               (OCINSTRUCTION_G | OCINSTRUCTION_E)
#define OCINSTRUCTION_LE               (OCINSTRUCTION_L | OCINSTRUCTION_E)
#define OCINSTRUCTION_NE               (OCINSTRUCTION_N | OCINSTRUCTION_E)
#define OCINSTRUCTION_NO               (OCINSTRUCTION_N | OCINSTRUCTION_O)
#define OCINSTRUCTION_NS               (OCINSTRUCTION_N | OCINSTRUCTION_S)
