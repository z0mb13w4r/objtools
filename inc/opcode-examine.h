...
#define OCINSN_ADD                     (0xf4)
#define OCINSN_DEC                     (0xf5)
#define OCINSN_DIV                     (0xf6)
#define OCINSN_INC                     (0xf7)
#define OCINSN_MUL                     (0xf8)
#define OCINSN_NEG                     (0xf9)
#define OCINSN_NOT                     (0xfa)
#define OCINSN_SUB                     (0xfb)
