...
#define OCINSN_CMP                     (224)
#define OCINSN_TST                     (225)
#define OCINSN_BTST                    (226)
#define OCINSN_LDA                     (227)
#define OCINSN_MOV                     (228)
#define OCINSN_STA                     (229)
#define OCINSN_Bxx                     (230)
#define OCINSN_Jxx                     (231)
#define OCINSN_ADD                     (232)
#define OCINSN_AND                     (233)
#define OCINSN_DEC                     (234)
#define OCINSN_DIV                     (235)
#define OCINSN_INC                     (236)
#define OCINSN_MAX                     (237)
#define OCINSN_MIN                     (238)
#define OCINSN_MUL                     (239)
#define OCINSN_NEG                     (240)
#define OCINSN_NOT                     (241)
#define OCINSN_ORR                     (242)
