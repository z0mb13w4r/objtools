...
#define OCINSN_CMP                     (222)
#define OCINSN_TST                     (223)
#define OCINSN_BTST                    (224)
#define OCINSN_LDA                     (225)
#define OCINSN_MOV                     (226)
#define OCINSN_STA                     (227)
#define OCINSN_Bxx                     (228)
#define OCINSN_Jxx                     (229)
#define OCINSN_ADD                     (230)
#define OCINSN_AND                     (231)
#define OCINSN_DEC                     (232)
#define OCINSN_DIV                     (233)
#define OCINSN_INC                     (234)
#define OCINSN_MAX                     (235)
#define OCINSN_MIN                     (236)
#define OCINSN_MUL                     (237)
#define OCINSN_NEG                     (238)
#define OCINSN_NOT                     (239)
#define OCINSN_ORR                     (240)
#define OCINSN_REM                     (241)
#define OCINSN_ROx                     (242)
#define OCINSN_SUB                     (243)
#define OCINSN_SxA                     (244)
#define OCINSN_SxL                     (245)
#define OCINSN_XOR                     (246)
#define OCINSN_PSH                     (247)
