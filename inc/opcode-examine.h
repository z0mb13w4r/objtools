...
#define OCINSTRUCTION_PUSH             ((6) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_POP              ((6) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_AND              ((7) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVB             ((8) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_MOVL             ((8) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_MOVQ             ((8) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_MOV              ((8) | OCINSTRUCTION_OPERAND2)
