...
#define OCINSN_FXCH                    (214)
#define OCINSN_XCHG                    (215)
#define OCINSN_INS                     (216)
#define OCINSN_OUTS                    (217)
#define OCINSN_CMP                     (218)
#define OCINSN_TST                     (219)
#define OCINSN_BTST                    (220)
#define OCINSN_LDA                     (221)
#define OCINSN_MOV                     (222)
#define OCINSN_STA                     (223)
#define OCINSN_Bxx                     (224)
#define OCINSN_Jxx                     (225)
#define OCINSN_ADD                     (226)
#define OCINSN_AND                     (227)
#define OCINSN_DEC                     (228)
#define OCINSN_DIV                     (229)
#define OCINSN_INC                     (230)
#define OCINSN_MAX                     (231)
#define OCINSN_MIN                     (232)
#define OCINSN_MUL                     (233)
#define OCINSN_NEG                     (234)
#define OCINSN_NOT                     (235)
#define OCINSN_ORR                     (236)
#define OCINSN_REM                     (237)
#define OCINSN_ROx                     (238)
#define OCINSN_SUB                     (239)
#define OCINSN_SxA                     (240)
#define OCINSN_SxL                     (241)
#define OCINSN_XOR                     (242)
#define OCINSN_XNOR                    (243)
#define OCINSN_PSH                     (244)
#define OCINSN_POP                     (245)
#define OCINSN_HLT                     (246)
#define OCINSN_RET                     (247)
#define OCINSN_REV                     (248)
#define OCINSN_NOP                     (249)
#define OCINSN_CALL                    (250)
...
#define OCINSN_LT               U64MASK(35)
#define OCINSN_RT               U64MASK(36)
#define OCINSN_A                U64MASK(37)
#define OCINSN_B                U64MASK(38)
#define OCINSN_C                U64MASK(39)
#define OCINSN_E                U64MASK(40)
#define OCINSN_G                U64MASK(41)
#define OCINSN_L                U64MASK(42)
#define OCINSN_N                U64MASK(43)
#define OCINSN_O                U64MASK(44)
