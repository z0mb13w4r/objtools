...
#define OCINSN_Bxx                     (237)
#define OCINSN_Jxx                     (238)
#define OCINSN_ADD                     (239)
#define OCINSN_AND                     (240)
#define OCINSN_DEC                     (241)
#define OCINSN_DIV                     (242)
#define OCINSN_INC                     (243)
#define OCINSN_MUL                     (244)
#define OCINSN_NEG                     (245)
#define OCINSN_NOT                     (246)
#define OCINSN_ORR                     (247)
