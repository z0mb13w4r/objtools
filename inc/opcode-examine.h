...
#define OCINSN_Bxx                     (236)
#define OCINSN_Jxx                     (237)
#define OCINSN_ADD                     (238)
#define OCINSN_AND                     (239)
#define OCINSN_DEC                     (240)
#define OCINSN_DIV                     (241)
#define OCINSN_INC                     (242)
#define OCINSN_MUL                     (243)
#define OCINSN_NEG                     (244)
#define OCINSN_NOT                     (245)
#define OCINSN_ORR                     (246)
#define OCINSN_ROx                     (247)
#define OCINSN_SUB                     (248)
#define OCINSN_SxL                     (249)
