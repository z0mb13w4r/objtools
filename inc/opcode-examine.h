...
#define OCINSN_LOG10                   (207)
#define OCINSN_FXCH                    (208)
#define OCINSN_XCHG                    (209)
#define OCINSN_IN                      (210)
#define OCINSN_OUT                     (211)
#define OCINSN_CMP                     (212)
#define OCINSN_TST                     (213)
#define OCINSN_BTST                    (214)
#define OCINSN_LDA                     (215)
#define OCINSN_MOV                     (216)
#define OCINSN_STA                     (217)
#define OCINSN_CLR                     (218)
#define OCINSN_SET                     (219)
