...
#define OCINSN_CMP                     (230)
#define OCINSN_TST                     (231)
#define OCINSN_MOV                     (232)
#define OCINSN_Bxx                     (233)
#define OCINSN_Jxx                     (234)
#define OCINSN_ADD                     (235)
#define OCINSN_AND                     (236)
#define OCINSN_DEC                     (237)
#define OCINSN_DIV                     (238)
#define OCINSN_INC                     (239)
