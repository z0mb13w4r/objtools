...
#define OCINSN_CMP                     (220)
#define OCINSN_TST                     (221)
#define OCINSN_BTST                    (222)
#define OCINSN_LDA                     (223)
#define OCINSN_MOV                     (224)
#define OCINSN_STA                     (225)
#define OCINSN_Bxx                     (226)
#define OCINSN_Jxx                     (227)
#define OCINSN_ADD                     (228)
#define OCINSN_AND                     (229)
#define OCINSN_DEC                     (230)
#define OCINSN_DIV                     (231)
#define OCINSN_INC                     (232)
#define OCINSN_MAX                     (233)
#define OCINSN_MIN                     (234)
#define OCINSN_MUL                     (235)
#define OCINSN_NEG                     (236)
#define OCINSN_NOT                     (237)
#define OCINSN_ORR                     (238)
#define OCINSN_REM                     (239)
#define OCINSN_ROx                     (240)
#define OCINSN_SUB                     (241)
#define OCINSN_SxA                     (242)
#define OCINSN_SxL                     (243)
#define OCINSN_XOR                     (244)
