...
#define OCINSN_CMP                     (219)
#define OCINSN_TST                     (220)
#define OCINSN_BTST                    (221)
#define OCINSN_LDA                     (222)
#define OCINSN_MOV                     (223)
#define OCINSN_STA                     (224)
#define OCINSN_Bxx                     (225)
#define OCINSN_Jxx                     (226)
#define OCINSN_ADD                     (227)
#define OCINSN_AND                     (228)
#define OCINSN_DEC                     (229)
#define OCINSN_DIV                     (230)
#define OCINSN_INC                     (231)
#define OCINSN_MAX                     (232)
#define OCINSN_MIN                     (233)
#define OCINSN_MUL                     (234)
#define OCINSN_NEG                     (235)
#define OCINSN_NOT                     (236)
#define OCINSN_ORR                     (237)
#define OCINSN_REM                     (238)
#define OCINSN_ROx                     (239)
#define OCINSN_SUB                     (240)
#define OCINSN_SxA                     (241)
#define OCINSN_SxL                     (242)
#define OCINSN_XOR                     (243)
#define OCINSN_XNOR                    (244)
#define OCINSN_PSH                     (245)
#define OCINSN_POP                     (246)
#define OCINSN_HLT                     (247)
#define OCINSN_RET                     (248)
#define OCINSN_REV                     (249)
#define OCINSN_NOP                     (250)
#define OCINSN_CALL                    (251)
#define OCINSN_BREAK                   (252)
#define OCINSN_UNDEF                   (253)
#define OCINSN_TOINT                   (254)
#define OCINSN_TOFLOAT                 (255)
