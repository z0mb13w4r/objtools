...
#define OCINSTRUCTION_COMISD           ((0x07) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_LEAVE            ((0x08) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_RET              ((0x09) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_HLT              ((0x0a) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_PUSH             ((0x0b) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_POP              ((0x0c) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_ADD              ((0x0d) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_DEC              ((0x0e) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_DIV              ((0x0f) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_DIVSD            ((0x10) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_IDIV             ((0x11) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_IMUL             ((0x12) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_OPERAND3)
#define OCINSTRUCTION_INC              ((0x13) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_MUL              ((0x14) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_NEG              ((0x15) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_NOT              ((0x16) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_SBB              ((0x17) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SUB              ((0x18) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_AND              ((0x19) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_OR               ((0x1a) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_ROx              ((0x1b) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SAx              ((0x1c) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SHx              ((0x1d) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_XOR              ((0x1e) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SETx             ((0x1f) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_MOV              ((0x20) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVS             ((0x21) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVSx            ((0x22) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVZx            ((0x23) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVSX            ((0x24) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVSXD           ((0x25) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVZX            ((0x26) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_LEA              ((0x27) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CMOVx            ((0x28) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_XCHG             ((0x29) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_Cxxx             ((0x2a) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_Cyyy             ((0x2b) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_CVTSI2SD         ((0x2c) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CVTTSD2SI        ((0x2d) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_NOP              ((0x2e) | OCINSTRUCTION_OPERAND0 | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_INS              ((0x2f) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CMPS             ((0x30) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_LODS             ((0x31) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_OUTS             ((0x32) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SCAS             ((0x33) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_STOS             ((0x34) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CMPXCHG          ((0x35) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_FLD              ((0x36) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_FST              ((0x37) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_FSTP             ((0x38) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_FXCH             ((0x39) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_MOVABS           ((0x3a) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_MOVDQA           ((0x3b) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_128BIT | OCINSTRUCTION_ALIGNED)
#define OCINSTRUCTION_MOVDQU           ((0x3c) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_128BIT | OCINSTRUCTION_UNALIGNED)
#define OCINSTRUCTION_MOVUPS           ((0x3d) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_128BIT | OCINSTRUCTION_UNALIGNED)
#define OCINSTRUCTION_MOVAPD           ((0x3e) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_ALIGNED)
#define OCINSTRUCTION_MOVAPS           ((0x3f) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_128BIT | OCINSTRUCTION_256BIT | OCINSTRUCTION_512BIT)
#define OCINSTRUCTION_FINIT            ((0x40) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_BSWAP            ((0x41) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_PEXTRx           ((0x42) | OCINSTRUCTION_OPERAND3)
#define OCINSTRUCTION_BSF              ((0x43) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_PADDx            ((0x44) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_PINSRx           ((0x45) | OCINSTRUCTION_OPERAND3 | OCINSTRUCTION_OPERAND4)
#define OCINSTRUCTION_PCMPEQx          ((0x46) | OCINSTRUCTION_OPERAND2 | OCINSTRUCTION_OPERAND3)
#define OCINSTRUCTION_PSHUFx           ((0xfc) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SHA1x            ((0xfd) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CPUID            ((0xfe) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_UNDEF            ((0xff) | OCINSTRUCTION_OPERAND0)
...
#define OCINSTRUCTION_BTCB             (OCINSTRUCTION_BT | OCINSTRUCTION_C | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_BTCL             (OCINSTRUCTION_BT | OCINSTRUCTION_C | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_BTCQ             (OCINSTRUCTION_BT | OCINSTRUCTION_C | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_BTCW             (OCINSTRUCTION_BT | OCINSTRUCTION_C | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_BTC              (OCINSTRUCTION_BT | OCINSTRUCTION_C)
#define OCINSTRUCTION_BTSB             (OCINSTRUCTION_BT | OCINSTRUCTION_S | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_BTSL             (OCINSTRUCTION_BT | OCINSTRUCTION_S | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_BTSQ             (OCINSTRUCTION_BT | OCINSTRUCTION_S | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_BTSW             (OCINSTRUCTION_BT | OCINSTRUCTION_S | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_BTS              (OCINSTRUCTION_BT | OCINSTRUCTION_S)
#define OCINSTRUCTION_BTB              (OCINSTRUCTION_BT | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_BTL              (OCINSTRUCTION_BT | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_BTQ              (OCINSTRUCTION_BT | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_BTW              (OCINSTRUCTION_BT | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_ADCB             (OCINSTRUCTION_ADC | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_ADCL             (OCINSTRUCTION_ADC | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_ADCQ             (OCINSTRUCTION_ADC | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_ADCW             (OCINSTRUCTION_ADC | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_ADDSB            (OCINSTRUCTION_ADDS | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_ADDSL            (OCINSTRUCTION_ADDS | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_ADDSQ            (OCINSTRUCTION_ADDS | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_ADDSW            (OCINSTRUCTION_ADDS | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_MULSB            (OCINSTRUCTION_MULS | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_MULSL            (OCINSTRUCTION_MULS | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_MULSQ            (OCINSTRUCTION_MULS | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_MULSW            (OCINSTRUCTION_MULS | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_SUBSB            (OCINSTRUCTION_SUBS | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_SUBSD            (OCINSTRUCTION_SUBS | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_SUBSL            (OCINSTRUCTION_SUBS | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_SUBSQ            (OCINSTRUCTION_SUBS | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_SUBSW            (OCINSTRUCTION_SUBS | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_FLDT             (OCINSTRUCTION_FLD | OCINSTRUCTION_80BIT)
...
#define OCINSTRUCTION_FSTPT            (OCINSTRUCTION_FSTP | OCINSTRUCTION_80BIT)
...
#define OCINSTRUCTION_PADDB            (OCINSTRUCTION_PADDx | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_PADDL            (OCINSTRUCTION_PADDx | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_PADDQ            (OCINSTRUCTION_PADDx | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_PADDW            (OCINSTRUCTION_PADDx | OCINSTRUCTION_16BIT)
...
#define OCINSTRUCTION_PEXTRB           (OCINSTRUCTION_PEXTRx | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_PEXTRW           (OCINSTRUCTION_PEXTRx | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_PEXTRL           (OCINSTRUCTION_PEXTRx | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_PEXTRQ           (OCINSTRUCTION_PEXTRx | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_PINSRB           (OCINSTRUCTION_PINSRx | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_PINSRW           (OCINSTRUCTION_PINSRx | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_PINSRL           (OCINSTRUCTION_PINSRx | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_PINSRQ           (OCINSTRUCTION_PINSRx | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_PCMPEQB          (OCINSTRUCTION_PCMPEQx | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_PCMPEQW          (OCINSTRUCTION_PCMPEQx | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_PCMPEQL          (OCINSTRUCTION_PCMPEQx | OCINSTRUCTION_32BIT)
#define OCINSTRUCTION_PCMPEQQ          (OCINSTRUCTION_PCMPEQx | OCINSTRUCTION_64BIT)
#define OCINSTRUCTION_PSHUFB           (OCINSTRUCTION_PSHUFx | OCINSTRUCTION_8BIT)
#define OCINSTRUCTION_PSHUFW           (OCINSTRUCTION_PSHUFx | OCINSTRUCTION_16BIT)
#define OCINSTRUCTION_PSHUFL           (OCINSTRUCTION_PSHUFx | OCINSTRUCTION_32BIT)
