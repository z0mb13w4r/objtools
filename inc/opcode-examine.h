...
#define OCINSN_ADD                     (240)
#define OCINSN_AND                     (241)
#define OCINSN_DEC                     (242)
#define OCINSN_DIV                     (243)
#define OCINSN_INC                     (244)
#define OCINSN_MUL                     (245)
#define OCINSN_NEG                     (246)
#define OCINSN_NOT                     (247)
#define OCINSN_ORR                     (248)
#define OCINSN_ROx                     (249)
#define OCINSN_SUB                     (250)
#define OCINSN_XOR                     (251)
#define OCINSN_PUSH                    (252)
#define OCINSN_POP                     (253)
