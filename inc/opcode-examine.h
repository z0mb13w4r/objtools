...
#define OCINSN_ADD                     (243)
#define OCINSN_AND                     (244)
#define OCINSN_DEC                     (245)
#define OCINSN_DIV                     (246)
#define OCINSN_INC                     (247)
#define OCINSN_MUL                     (248)
#define OCINSN_NEG                     (249)
#define OCINSN_NOT                     (250)
