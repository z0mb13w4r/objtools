...
#define OCINSN_CMP                     (221)
#define OCINSN_TST                     (222)
#define OCINSN_BTST                    (223)
#define OCINSN_LDA                     (224)
#define OCINSN_MOV                     (225)
#define OCINSN_STA                     (226)
#define OCINSN_Bxx                     (227)
#define OCINSN_Jxx                     (228)
#define OCINSN_ADD                     (229)
#define OCINSN_AND                     (230)
#define OCINSN_DEC                     (231)
#define OCINSN_DIV                     (232)
#define OCINSN_INC                     (233)
#define OCINSN_MAX                     (234)
#define OCINSN_MIN                     (235)
#define OCINSN_MUL                     (236)
#define OCINSN_NEG                     (237)
#define OCINSN_NOT                     (238)
#define OCINSN_ORR                     (239)
#define OCINSN_REM                     (240)
#define OCINSN_ROx                     (241)
#define OCINSN_SUB                     (242)
#define OCINSN_SxA                     (243)
#define OCINSN_SxL                     (244)
#define OCINSN_XOR                     (245)
#define OCINSN_PSH                     (246)
#define OCINSN_POP                     (247)
#define OCINSN_HLT                     (248)
#define OCINSN_RET                     (249)
