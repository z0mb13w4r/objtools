...
#define OCINSN_CMP                     (228)
#define OCINSN_TST                     (229)
#define OCINSN_MOV                     (230)
#define OCINSN_Bxx                     (231)
#define OCINSN_Jxx                     (232)
#define OCINSN_ADD                     (233)
#define OCINSN_AND                     (234)
#define OCINSN_DEC                     (235)
#define OCINSN_DIV                     (236)
#define OCINSN_INC                     (237)
#define OCINSN_MAX                     (238)
#define OCINSN_MIN                     (239)
#define OCINSN_MUL                     (240)
#define OCINSN_NEG                     (241)
#define OCINSN_NOT                     (242)
#define OCINSN_ORR                     (243)
#define OCINSN_ROx                     (244)
#define OCINSN_SUB                     (245)
#define OCINSN_SxA                     (246)
#define OCINSN_SxL                     (247)
#define OCINSN_XOR                     (248)
#define OCINSN_PSH                     (249)
#define OCINSN_POP                     (250)
