...
#define OCINSN_PI                      (208)
#define OCINSN_LOGE                    (209)
#define OCINSN_LOG2                    (210)
#define OCINSN_LOG10                   (211)
#define OCINSN_FXCH                    (212)
#define OCINSN_XCHG                    (213)
#define OCINSN_INS                     (214)
#define OCINSN_OUTS                    (215)
#define OCINSN_CMP                     (216)
#define OCINSN_TST                     (217)
#define OCINSN_BTST                    (218)
#define OCINSN_LDA                     (219)
#define OCINSN_MOV                     (220)
#define OCINSN_STA                     (221)
#define OCINSN_Bxx                     (222)
#define OCINSN_Jxx                     (223)
#define OCINSN_ADD                     (224)
#define OCINSN_AND                     (225)
#define OCINSN_DEC                     (226)
#define OCINSN_DIV                     (227)
#define OCINSN_INC                     (228)
#define OCINSN_MAX                     (229)
#define OCINSN_MIN                     (230)
#define OCINSN_MUL                     (231)
#define OCINSN_NEG                     (232)
#define OCINSN_NOT                     (233)
#define OCINSN_ORR                     (234)
#define OCINSN_REM                     (235)
#define OCINSN_ROx                     (236)
#define OCINSN_SCA                     (237)
#define OCINSN_SUB                     (238)
...
#define OCINSN_ADDRESS          U64MASK(32)
#define OCINSN_IMMEDIATE        U64MASK(33)
#define OCINSN_REGISTER         U64MASK(34)
