...
#define OCINSTRUCTION_A                U64MASK(39)
#define OCINSTRUCTION_AE               U64MASK(40)
#define OCINSTRUCTION_B                U64MASK(41)
#define OCINSTRUCTION_BE               U64MASK(42)
#define OCINSTRUCTION_E                U64MASK(43)
#define OCINSTRUCTION_G                U64MASK(44)
#define OCINSTRUCTION_GE               U64MASK(45)
#define OCINSTRUCTION_L                U64MASK(46)
#define OCINSTRUCTION_LE               U64MASK(47)
#define OCINSTRUCTION_NE               U64MASK(48)
#define OCINSTRUCTION_NS               U64MASK(49)
#define OCINSTRUCTION_S                U64MASK(50)
#define OCINSTRUCTION_BND              U64MASK(51)
#define OCINSTRUCTION_DATA16           U64MASK(52)
#define OCINSTRUCTION_DATA32           U64MASK(53)
...
#define OCINSTRUCTION_SAL              ((0x16) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SAR              ((0x17) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SHL              ((0x18) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SHR              ((0x19) | OCINSTRUCTION_OPERAND1 | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_XOR              ((0x1a) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_SET              ((0x1b) | OCINSTRUCTION_OPERAND1)
#define OCINSTRUCTION_MOV              ((0x1c) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_LEA              ((0x1d) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_CMOV             ((0x1e) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_XCHG             ((0x1f) | OCINSTRUCTION_OPERAND2)
#define OCINSTRUCTION_Cxxx             ((0x20) | OCINSTRUCTION_OPERAND0)
#define OCINSTRUCTION_NOP              ((0x21) | OCINSTRUCTION_OPERAND0)
...
#define OCINSTRUCTION_SETA             (OCINSTRUCTION_SET | OCINSTRUCTION_A)
#define OCINSTRUCTION_SETAE            (OCINSTRUCTION_SET | OCINSTRUCTION_AE)
#define OCINSTRUCTION_SETB             (OCINSTRUCTION_SET | OCINSTRUCTION_B)
#define OCINSTRUCTION_SETBE            (OCINSTRUCTION_SET | OCINSTRUCTION_BE)
#define OCINSTRUCTION_SETE             (OCINSTRUCTION_SET | OCINSTRUCTION_E)
#define OCINSTRUCTION_SETG             (OCINSTRUCTION_SET | OCINSTRUCTION_G)
#define OCINSTRUCTION_SETGE            (OCINSTRUCTION_SET | OCINSTRUCTION_GE)
#define OCINSTRUCTION_SETL             (OCINSTRUCTION_SET | OCINSTRUCTION_L)
#define OCINSTRUCTION_SETLE            (OCINSTRUCTION_SET | OCINSTRUCTION_LE)
#define OCINSTRUCTION_SETNE            (OCINSTRUCTION_SET | OCINSTRUCTION_NE)
#define OCINSTRUCTION_SETNS            (OCINSTRUCTION_SET | OCINSTRUCTION_NS)
#define OCINSTRUCTION_SETS             (OCINSTRUCTION_SET | OCINSTRUCTION_S)
#define OCINSTRUCTION_CMOVA            (OCINSTRUCTION_CMOV | OCINSTRUCTION_A)
#define OCINSTRUCTION_CMOVAE           (OCINSTRUCTION_CMOV | OCINSTRUCTION_AE)
#define OCINSTRUCTION_CMOVB            (OCINSTRUCTION_CMOV | OCINSTRUCTION_B)
#define OCINSTRUCTION_CMOVBE           (OCINSTRUCTION_CMOV | OCINSTRUCTION_BE)
#define OCINSTRUCTION_CMOVE            (OCINSTRUCTION_CMOV | OCINSTRUCTION_E)
#define OCINSTRUCTION_CMOVG            (OCINSTRUCTION_CMOV | OCINSTRUCTION_G)
#define OCINSTRUCTION_CMOVGE           (OCINSTRUCTION_CMOV | OCINSTRUCTION_GE)
#define OCINSTRUCTION_CMOVL            (OCINSTRUCTION_CMOV | OCINSTRUCTION_L)
#define OCINSTRUCTION_CMOVLE           (OCINSTRUCTION_CMOV | OCINSTRUCTION_LE)
#define OCINSTRUCTION_CMOVNE           (OCINSTRUCTION_CMOV | OCINSTRUCTION_NE)
#define OCINSTRUCTION_CMOVNS           (OCINSTRUCTION_CMOV | OCINSTRUCTION_NS)
#define OCINSTRUCTION_CMOVS            (OCINSTRUCTION_CMOV | OCINSTRUCTION_S)
