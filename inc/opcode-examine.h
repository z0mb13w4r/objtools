...
#define OCINSN_CMP                     (232)
#define OCINSN_TST                     (233)
#define OCINSN_MOV                     (234)
#define OCINSN_Bxx                     (235)
#define OCINSN_Jxx                     (236)
#define OCINSN_ADD                     (237)
#define OCINSN_AND                     (238)
#define OCINSN_DEC                     (239)
#define OCINSN_DIV                     (240)
#define OCINSN_INC                     (241)
#define OCINSN_MUL                     (242)
#define OCINSN_NEG                     (243)
#define OCINSN_NOT                     (244)
#define OCINSN_ORR                     (245)
#define OCINSN_ROx                     (246)
#define OCINSN_SUB                     (247)
#define OCINSN_SxA                     (248)
