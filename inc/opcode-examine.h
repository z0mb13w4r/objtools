...
#define OCINSN_ADD                     (241)
#define OCINSN_AND                     (242)
#define OCINSN_DEC                     (243)
#define OCINSN_DIV                     (244)
#define OCINSN_INC                     (245)
#define OCINSN_MUL                     (246)
#define OCINSN_NEG                     (247)
#define OCINSN_NOT                     (248)
#define OCINSN_ORR                     (249)
#define OCINSN_ROx                     (250)
#define OCINSN_SUB                     (251)
