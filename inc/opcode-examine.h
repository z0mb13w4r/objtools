...
#define OCINSN_CMP                     (229)
#define OCINSN_TST                     (230)
#define OCINSN_MOV                     (231)
#define OCINSN_Bxx                     (232)
#define OCINSN_Jxx                     (233)
#define OCINSN_ADD                     (234)
#define OCINSN_AND                     (235)
#define OCINSN_DEC                     (236)
#define OCINSN_DIV                     (237)
#define OCINSN_INC                     (238)
