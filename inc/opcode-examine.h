...
#define OCINSN_ADD                     (242)
#define OCINSN_AND                     (243)
#define OCINSN_DEC                     (244)
#define OCINSN_DIV                     (245)
#define OCINSN_INC                     (246)
#define OCINSN_MUL                     (247)
#define OCINSN_NEG                     (248)
#define OCINSN_NOT                     (249)
#define OCINSN_ORR                     (250)
