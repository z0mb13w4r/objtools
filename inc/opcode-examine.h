...
#define OCINSN_SIN                     (200)
#define OCINSN_TAN                     (201)
#define OCINSN_ATAN                    (202)
#define OCINSN_PI                      (203)
#define OCINSN_LOGE                    (204)
#define OCINSN_LOG2                    (205)
#define OCINSN_LOG10                   (206)
#define OCINSN_FXCH                    (207)
#define OCINSN_XCHG                    (208)
#define OCINSN_IN                      (209)
#define OCINSN_OUT                     (210)
#define OCINSN_CMP                     (211)
#define OCINSN_TST                     (212)
#define OCINSN_BTST                    (213)
#define OCINSN_LDA                     (214)
#define OCINSN_MOV                     (215)
#define OCINSN_STA                     (216)
#define OCINSN_CLR                     (217) /* CLEAR Instruction */
#define OCINSN_SET                     (218) /* SET Instruction */
#define OCINSN_EXT                     (219) /* EXTRACT Instruction */
#define OCINSN_Bxx                     (220)
#define OCINSN_Jxx                     (221)
#define OCINSN_ADD                     (222)
#define OCINSN_AND                     (223)
#define OCINSN_DEC                     (224)
#define OCINSN_DIV                     (225)
#define OCINSN_INC                     (226)
#define OCINSN_MAX                     (227)
#define OCINSN_MIN                     (228)
#define OCINSN_MUL                     (229)
#define OCINSN_NEG                     (230)
#define OCINSN_NOT                     (231)
#define OCINSN_ORR                     (232)
#define OCINSN_REM                     (233)
#define OCINSN_ROx                     (234)
#define OCINSN_SCA                     (235)
...
#define OCINSN_O                U64MASK(43) // OCINSNX86_OFLAG
#define OCINSN_P                U64MASK(44) // OCINSNX86_PFLAG
#define OCINSN_S                U64MASK(45) // OCINSNX86_SFLAG
#define OCINSN_Z                U64MASK(46) // OCINSNX86_ZFLAG
