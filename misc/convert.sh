...
echo "Each Base64 digit represents exactly 6 bits of data." | ${PRGNAMENG} base64e -
...
# -> BASE64 -> BASE32
# double_bases
echo "TVJYWEtZVE1NVlBXRVlMVE1WWlE9PT09" | ${PRGNAMENG} base64d base32d -
...
# -> BASE32 -> BASE58 -> HEX -> BASE64 [BROKEN]
# base16_is_hex
echo GM4HOU3VHBAW6OKNJJFW6SS2IZ3VAMTYORFDMUC2G44EQULIJI3WIVRUMNCWI6KGK5XEKZDTN5YU2RT2MR3E45KKI5TXSOJTKZJTC4KRKFDWKZTZOF3TORJTGZTXGNKCOE | ${PRGNAMENG} base32d -
#base58d hex8d base64d -

# PJXHQ4S7GEZV6ZTDOZQQ====
# -> BASE32 -> ROT13
# make_13_spin
echo PJXHQ4S7GEZV6ZTDOZQQ==== | ${PRGNAMENG} base32d rot13 -

# 2W1V8GQ5TELfYurYCZvEQV1q6RhagcEwZgi7n25vVvS
# -> BASE58
# base58 is super common in CTF's
echo "base58 is super common in CTF's" | ${PRGNAMENG} base58e -
echo "2W1V8GQ5TELfYurYCZvEQV1q6RhagcEwZgi7n25vVvS" | ${PRGNAMENG} base58d -

#echo 'egmpeg"md"vjg"hwleng' | ${PRGNAMENG} xor8brute -
#echo 'egmpeg"md"vjg"hwleng' | ${PRGNAMENG} xor16brute -
