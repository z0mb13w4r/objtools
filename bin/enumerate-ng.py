...
if __name__ == '__main__':
  ...
  p.add_argument('--sys', action='store_true', help='system information.')
  p.add_argument('--usr', action='store_true', help='user & group information.')
  p.add_argument('--env', action='store_true', help='environmental information.')
  p.add_argument('--job', action='store_true', help='jobs & tasks information.')
  p.add_argument('--net', action='store_true', help='networking information.')
  p.add_argument('--srv', action='store_true', help='services information.')
  p.add_argument('--sft', action='store_true', help='software information.')
  p.add_argument('--ask', action='store_true', help='interesting files information.')
  g = p.parse_args()
